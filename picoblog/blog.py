...
class AbstractPageHandler(request.BlogRequestHandler):
    ...
    def handle_custom_tag_mp3(self, input):
        ...
        repl_flash = "<object width='160' height='20'><embed src='" + repl_swf + "' width='160' height='20' type='application/x-shockwave-flash' flashvars='&mp3=" + repl_link + "' quality='high'></embed></object>"

...
class SomeTests(TestCase):
  ...
  def test_format_time_hms_s(self):
    from utils import format_time_hms
    self.failUnlessEqual('0:00:05', format_time_hms(5))

  def test_format_time_hms_ms(self):
    from utils import format_time_hms
    self.failUnlessEqual('0:01:30', format_time_hms(90))

  def test_format_time_hms_float(self):
    from utils import format_time_hms
    self.failUnlessEqual('0:01:30', format_time_hms(90.123))

  def test_format_time_hms_hms(self):
    from utils import format_time_hms
    self.failUnlessEqual('1:01:30', format_time_hms(3600 + 60 + 30))
...
abs_difference = abs(volt_sum_1 - volt_sum_2)
relative_difference = float(abs_difference) / float(volt_sum_1)
print "volt_sum_1: ", volt_sum_1
print "volt_sum_2: ", volt_sum_2
print "abs difference: %d" % (abs_difference)
print "rel difference: %.3f %%" % (relative_difference*100)